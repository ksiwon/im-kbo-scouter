...
export const ANALYSIS_DATA: Record<string, AnalysisContent> = {
  ...
  "kfs-explanation": {
    title: "📝 KFS Score의 철학: 데이터가 말하는 성공",
    content: [
      "KFS Score는 단순히 과거 데이터를 보여주는 것이 아니라, '미래의 성공 확률'을 계산하는 도구입니다.",
      "데이터 분석 결과, wRC+는 KBO 성적과 상관관계가 거의 없으며(r ≈ -0.12), 오히려 BABIP와 OBP가 핵심 지표임이 밝혀졌습니다.",
      "100점 만점으로 환산된 이 점수가 여러분의 스카우팅에 확신을 더해줄 것입니다."
    ],
    insight: "성공의 열쇠: 높은 BABIP와 OBP를 바탕으로 한 생산력, 그리고 확실한 파워."
  },
  "aaa-scouting": {
    title: "🎯 2025 AAA 유망주 리포트 (KFS 기반)",
    content: [
      "KFS 모델(BABIP > OBP > HR)에 따르면, 2025년 AAA 타자 중 '성공 잠재력'이 높은 유형은 명확합니다.",
      "단순히 wRC+가 높은 타자보다는, '확실한 파워(HR)'와 '인플레이 타구 생산(BABIP)' 능력을 겸비한 선수가 유리합니다.",
      "특히 ABS 환경에서는 '삼진을 당하지 않는 파워 히터'보다는 '적극적으로 타격하여 결과를 만드는 타자'가 더 높은 평가를 받습니다."
    ],
    insight: "추천 전략: wRC+보다는 BABIP, OBP, HR 등 개별 지표의 경쟁력을 확인하세요."
  },
  prediction: {
